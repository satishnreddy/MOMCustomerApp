...
class SocketConnector
{
    ...
    private void connectSocket() throws WebSocketException
    {
        ...
        catch (EOFException e)
        {
            ...
            throw new WebSocketException(WebSocketError.EOF_EXCEPTION, "", e);
        }
        catch (SSLException e)
        {
            ...
            throw new WebSocketException(WebSocketError.SSL_EXCEPTION, "", e);
        }
        catch(SocketException e)
        {
            ...
            throw new WebSocketException(WebSocketError.SOCKET_EXCEPTION, "", e);
        }
        catch(SocketTimeoutException e)
        {
            ...
            throw new WebSocketException(WebSocketError.SOCKET_TIMEOUT_EXCEPTION, "", e);
        }
        catch (UnknownHostException e)
        {
            ...
            throw new WebSocketException(WebSocketError.UNKNOWN_HOST_EXCEPTION, "", e);
        }
        catch (Exception e)
        {
            if(ApplicationData.IS_DEBUGGING_ON)
    ...
    private InetAddress[] resolveHostname() throws WebSocketException
    {
        ...
        // Raise an exception with SOCKET_CONNECT_ERROR.
        throw new WebSocketException(WebSocketError.UNKNOWN_HOST_EXCEPTION, message, exception);
    }
